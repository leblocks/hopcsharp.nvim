...
describe('hop_to_definition', function()
    ...
    it('__hop_to_definition hops from nested generic class correctly', function()
        ...
        utils.prepare('test/sources/get_type_hierarchy.cs', 'test/sources/get_type_hierarchy.cs', 43, 22)
        local called = false
        hop.__hop_to_definition({
            callback = function(definitions)
                called = true
    ...
    it('__hop_to_definition hops from generic class correctly', function()
        ...
        utils.prepare('test/sources/get_type_hierarchy.cs', 'test/sources/get_type_hierarchy.cs', 48, 16)
        local called = false
        hop.__hop_to_definition({
            callback = function(definitions)
                called = true
    ...
    it('__hop_to_definition hops correctly from This.Is.Nested.Namespace namespace to This.Is.Nested namespace', function()
        local files_to_parse = {
